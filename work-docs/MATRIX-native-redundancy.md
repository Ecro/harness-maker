...
across models, `**` measured once, `*` judgement, `unsourced` no evidence meeting the bar —
inherited with no RESEARCH row, or researched and none found (30 of 85). TUNE evidence is
**Side-preset only** (stage-agent ledger has no Production rows).
