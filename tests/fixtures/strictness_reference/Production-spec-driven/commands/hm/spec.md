...
description: Lock what and why — acceptance criteria via a 6-category interview into
  a SPEC doc.
content_hash: a7b0922db0e15c324c99ffe7e6a163b8a068ef51537e8203f5290a2b23089948
---
...
```bash
!uv run --with $HOME/harness-maker hm worktree task-preflight <slug> "$(pwd)" --stage hm:spec --claude-session-id "$HM_SESSION_ID"
```
...
### Step 2 — Interview (default ON; unlimited rounds)
