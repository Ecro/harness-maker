...
content_hash: b4ba72296ced4b0c22e06bbeddd57f2ed5cbc9c48ea800861f8eecca674bba9e
---
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T1017Z python -m harness_maker.cli security-scan .
```
