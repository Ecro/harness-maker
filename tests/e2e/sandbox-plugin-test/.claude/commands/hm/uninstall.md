...
provenance: official
content_hash: 07917dede7eec3caf854c93f365fee052b13370828afc8a9581b00389b10de76
---
# /hm:uninstall
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T1406Z python -m harness_maker.cli remove "$(pwd)" --dry-run
```
...
```bash
# Keep harness.yaml
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T1406Z python -m harness_maker.cli remove "$(pwd)"

# Remove everything
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T1406Z python -m harness_maker.cli remove "$(pwd)" --remove-yaml
```
