...
provenance: official
content_hash: 9529bf0126555454e0b8ff48befd5683af02076a4c1d212697ecb233bdb3f102
---
# /hm:loop
...
3. **Finalize worktree** (only if engaged in step 5):
   ...
   ```bash
   !uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T1017Z python -m harness_maker.worktree finalize <WT> <STATUS>
   ```
