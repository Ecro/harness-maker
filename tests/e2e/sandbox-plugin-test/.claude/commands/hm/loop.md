...
provenance: official
content_hash: bc16e37e4dc93876de7ce2a2fa1eb6a69120dccd6d05297daf14e462e9785d6f
---
# /hm:loop
...
3. **Finalize worktree** (only if engaged in step 5):
   ...
   ```bash
   !uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T0738Z python -m harness_maker.worktree finalize <WT> <STATUS>
   ```
