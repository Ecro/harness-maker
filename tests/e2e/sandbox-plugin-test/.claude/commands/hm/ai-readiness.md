...
provenance: official
content_hash: f883becc5394fbeeb54ce05410dd7b744336532e38cbe42fd6a72360a3c1cd62
---
# /hm:ai-readiness
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T0738Z python -m harness_maker.cli ai-readiness . \
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T0738Z python -m harness_maker.cli ai-readiness-finalize \
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T0738Z python -m harness_maker.cli ai-readiness . --skip-llm
```
