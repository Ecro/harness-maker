...
content_hash: 1459acc35cd43375fc53f225999a00a723eb83a529905584efbc7f8295efaa94
---
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T0550Z python -m harness_maker.cli security-scan .
```
