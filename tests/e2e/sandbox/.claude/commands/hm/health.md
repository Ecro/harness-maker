...
provenance: official
content_hash: 326902de940ba892df2751a74202cb6594ec45a028251149e2b12a8a14d9efbf
---
# /hm:health
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260522T0302Z python -m harness_maker.cli health . --json-output .claude/observability/.health.tmp.json
```
