...
provenance: official
content_hash: 3cab283d8fbb15da5f1264e3fa4e470924403f50c04247d26becf71a682e248d
---
# /hm:ai-readiness
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T1017Z python -m harness_maker.cli ai-readiness . \
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T1017Z python -m harness_maker.cli ai-readiness-finalize \
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260508T1017Z python -m harness_maker.cli ai-readiness . --skip-llm
```
