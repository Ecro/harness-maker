...
provenance: official
content_hash: 45573b682e595a285b7f6a301e342bec40eda5c20353c35bd9e3045944bc9b96
---
# /hm:uninstall
...
```bash
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T0550Z python -m harness_maker.cli remove "$(pwd)" --dry-run
```
...
```bash
# Keep harness.yaml
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T0550Z python -m harness_maker.cli remove "$(pwd)"

# Remove everything
!uv run --with /home/noel/harness-maker/.worktrees/execute-20260516T0550Z python -m harness_maker.cli remove "$(pwd)" --remove-yaml
```
