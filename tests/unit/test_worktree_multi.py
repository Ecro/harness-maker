...
def _make_repo(path: Path, name: str = "main") -> Path:
    ...
    # Pre-track .gitignore — mirrors real-world (`.claude/` is fully
    # gitignored at user repos so harness-managed config + runtime state
    # never pollute `git status --porcelain`; ADR-002 dirty-base guard
