...
def make(
    ...
    add: str | None = typer.Option(None, "--add", help="Add a component by name"),  # noqa: ARG001
    remove: str | None = typer.Option(None, "--remove", help="Remove a component by name"),  # noqa: ARG001
