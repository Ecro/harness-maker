...
summary: L1 cluster invariants for Adaptive interview + 5-term gate.
---

## 🎯 Intent

L1 cluster `interview` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `interview`
...
See [SPEC-interview.machine.yaml](./SPEC-interview.machine.yaml).
