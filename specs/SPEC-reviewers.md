...
summary: L1 cluster invariants for Reviewer agents (code/security/perf/concurrency/etc.).
---

## 🎯 Intent

L1 cluster `reviewers` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `reviewers`
...
See [SPEC-reviewers.machine.yaml](./SPEC-reviewers.machine.yaml).
