...
summary: Auto-generated skeleton SPEC for template feature tpl-make-md.
---

## 🎯 Intent

`src/harness_maker/templates/commands/hm/make.md.j2` provides the **tpl-make-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-make-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-make-md is exercised
...
See [SPEC-tpl-make-md.machine.yaml](./SPEC-tpl-make-md.machine.yaml).
