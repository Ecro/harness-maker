...
summary: L1 cluster invariants for Harness.yaml synthesis.
---

## 🎯 Intent

L1 cluster `synthesis` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `synthesis`
...
See [SPEC-synthesis.machine.yaml](./SPEC-synthesis.machine.yaml).
