---
type: spec
task_slug: configuration-manifests
...
summary: L1 cluster invariants for Triple-plugin manifests + harness.yaml.
---

## 🎯 Intent

L1 cluster `configuration-manifests` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `configuration-manifests`
...
See [SPEC-configuration-manifests.machine.yaml](./SPEC-configuration-manifests.machine.yaml).
