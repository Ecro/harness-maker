...
summary: Auto-generated skeleton SPEC for template feature tpl-review-md.
---

## 🎯 Intent

`src/harness_maker/templates/stages/review.md.j2` provides the **tpl-review-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-review-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-review-md is exercised
...
See [SPEC-tpl-review-md.machine.yaml](./SPEC-tpl-review-md.machine.yaml).
