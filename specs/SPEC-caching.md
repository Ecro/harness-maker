...
summary: L1 cluster invariants for LLM judge cache + detection cache.
---

## 🎯 Intent

L1 cluster `caching` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `caching`
...
See [SPEC-caching.machine.yaml](./SPEC-caching.machine.yaml).
