...
summary: Auto-generated skeleton SPEC for template feature tpl-verify-md.
---

## 🎯 Intent

`src/harness_maker/templates/stages/verify.md.j2` provides the **tpl-verify-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-verify-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-verify-md is exercised
...
See [SPEC-tpl-verify-md.machine.yaml](./SPEC-tpl-verify-md.machine.yaml).
