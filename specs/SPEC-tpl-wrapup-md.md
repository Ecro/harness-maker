...
summary: Auto-generated skeleton SPEC for template feature tpl-wrapup-md.
---

## 🎯 Intent

`src/harness_maker/templates/stages/wrapup.md.j2` provides the **tpl-wrapup-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-wrapup-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-wrapup-md is exercised
...
See [SPEC-tpl-wrapup-md.machine.yaml](./SPEC-tpl-wrapup-md.machine.yaml).
