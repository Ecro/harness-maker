---
type: spec
task_slug: security-permissions
...
summary: L1 cluster invariants for Security scanner + permission gates.
---

## 🎯 Intent

L1 cluster `security-permissions` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `security-permissions`
...
See [SPEC-security-permissions.machine.yaml](./SPEC-security-permissions.machine.yaml).
