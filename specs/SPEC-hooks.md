...
summary: L1 cluster invariants for Claude/Cursor/Codex hook schemas.
---

## 🎯 Intent

L1 cluster `hooks` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `hooks`
...
See [SPEC-hooks.machine.yaml](./SPEC-hooks.machine.yaml).
