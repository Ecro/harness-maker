...
summary: Auto-generated skeleton SPEC for template feature tpl-mcp-json.
---

## 🎯 Intent

`src/harness_maker/templates/cursor/mcp.json.j2` provides the **tpl-mcp-json** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-mcp-json can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-mcp-json is exercised
...
See [SPEC-tpl-mcp-json.machine.yaml](./SPEC-tpl-mcp-json.machine.yaml).
