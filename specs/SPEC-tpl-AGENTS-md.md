...
summary: Auto-generated skeleton SPEC for template feature tpl-AGENTS-md.
---

## 🎯 Intent

`src/harness_maker/templates/codex/AGENTS.md.j2` provides the **tpl-AGENTS-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-AGENTS-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-AGENTS-md is exercised
...
See [SPEC-tpl-AGENTS-md.machine.yaml](./SPEC-tpl-AGENTS-md.machine.yaml).
