...
summary: L1 cluster invariants for Reconciliation + KEEP/REPLACE policy.
---

## 🎯 Intent

L1 cluster `reconciliation` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `reconciliation`
...
See [SPEC-reconciliation.machine.yaml](./SPEC-reconciliation.machine.yaml).
