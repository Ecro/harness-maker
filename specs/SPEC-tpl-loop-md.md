...
summary: Auto-generated skeleton SPEC for template feature tpl-loop-md.
---

## 🎯 Intent

`src/harness_maker/templates/commands/hm/loop.md.j2` provides the **tpl-loop-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-loop-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-loop-md is exercised
...
See [SPEC-tpl-loop-md.machine.yaml](./SPEC-tpl-loop-md.machine.yaml).
