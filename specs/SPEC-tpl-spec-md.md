...
summary: Auto-generated skeleton SPEC for template feature tpl-spec-md.
---

## 🎯 Intent

`src/harness_maker/templates/stages/spec.md.j2` provides the **tpl-spec-md** template feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-spec-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-spec-md is exercised
...
See [SPEC-tpl-spec-md.machine.yaml](./SPEC-tpl-spec-md.machine.yaml).
