...
summary: L1 cluster invariants for Autoloop driver + convergence gates.
---

## 🎯 Intent

L1 cluster `autoloop` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `autoloop`
...
See [SPEC-autoloop.machine.yaml](./SPEC-autoloop.machine.yaml).
