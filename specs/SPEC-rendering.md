...
summary: L1 cluster invariants for Rendering pipeline.
---

## 🎯 Intent

L1 cluster `rendering` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `rendering`
...
See [SPEC-rendering.machine.yaml](./SPEC-rendering.machine.yaml).
