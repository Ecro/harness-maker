...
summary: L1 cluster invariants for Worktree create/finalize/cleanup.
---

## 🎯 Intent

L1 cluster `worktree` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `worktree`
...
See [SPEC-worktree.machine.yaml](./SPEC-worktree.machine.yaml).
