...
summary: L1 cluster invariants for Project memory (wiki/failures/episodic/semantic).
---

## 🎯 Intent

L1 cluster `memory` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `memory`
...
See [SPEC-memory.machine.yaml](./SPEC-memory.machine.yaml).
