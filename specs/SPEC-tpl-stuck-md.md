...
summary: Auto-generated skeleton SPEC for agent feature tpl-stuck-md.
---

## 🎯 Intent

`src/harness_maker/templates/agents/stuck.md.j2` provides the **tpl-stuck-md** agent feature. This skeleton SPEC seeds AC slots for refinement via `/hm:spec` in a follow-up batch.

## 🌅 Outcomes

Consumers of tpl-stuck-md can rely on the AC below holding under the SPEC's verification regime.
...
**When** the contract surface of tpl-stuck-md is exercised
...
See [SPEC-tpl-stuck-md.machine.yaml](./SPEC-tpl-stuck-md.machine.yaml).
