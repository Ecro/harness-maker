...
summary: L1 cluster invariants for Jinja templates (claude-md/agents/skills/codex/cursor).
---

## 🎯 Intent

L1 cluster `templates` groups member L2 SPECs sharing invariants.
...
**Given** every L2 member of cluster `templates`
...
See [SPEC-templates.machine.yaml](./SPEC-templates.machine.yaml).
