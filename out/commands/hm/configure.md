...
content_hash: 9b2ecf7fae62c92cee1a66d2acb2c4b826b1a74f9ed6a31f34e2970cdb4fc8fd
---
# /hm:configure
...
```bash
!uv run --with $HOME/harness-maker hm cli \
...
```bash
!uv run --with $HOME/harness-maker hm cli make "$(pwd)" \
